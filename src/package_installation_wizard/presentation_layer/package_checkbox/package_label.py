...
from package_installation_wizard.presentation_layer.package_checkbox.manager_label import ManagerLabel
from stylesheet.data_layer.object_names import PACKAGE_LABEL
from package_installation_wizard.presentation_layer.package_checkbox.version_label import VersionLabel

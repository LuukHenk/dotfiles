...
from installation_wizard_widget.installation_wizard_widget_processor import (
    InstallationWizardWidgetProcessor,
)
...
class InstallationWizardWidget(QWidget):
    ...
    def __construct_active_group_widget(self) -> ActiveGroupWidget:
        ...
        for group, packages in self.__processor.package_info.items():
            active_group_widget.add_group(group, packages)
